function ReadSUVI_L1b_Fe195()
% This function will read in the GOES SUVI_L1B_Fe171
% data which is taken by the Solar Ultraviolet Imager at the Fe17` waveband
...
fprintf(fid,'\n');
fprintf(fid,'%s\n','**************Start reading SUVI-L1B-Fe195 Solar Radiation data***************');
...
netcdf.close(ncid);
fprintf(fid,'%s\n','Finished reading SUVI-L1b-Fe195 Data');
...
fprintf(fid,'%s\n',statstr2);
%Display RAD as an image-this is for the SUVI_L1b_Fe195 wavelength
