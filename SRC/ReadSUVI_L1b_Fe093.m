function ReadSUVI_L1b_Fe093()
% This function will read in the GOES SUVI_L1B_Fe093
...
fprintf(fid,'\n');
fprintf(fid,'%s\n','**************Start reading SUVI-L1B-Fe093 Solar Radiation data***************');
...
netcdf.close(ncid);
fprintf(fid,'%s\n','Finished reading SUV1-L1b-Fe093 Data');
