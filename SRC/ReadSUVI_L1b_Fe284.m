function ReadSUVI_L1b_Fe284()
% This function will read in the GOES SUVI_L1B_Fe284
% data which is taken by the Solar Ultraviolet Imager at the Fe284 waveband
...
fprintf(fid,'\n');
fprintf(fid,'%s\n','**************Start reading SUVI-L1B-Fe284 Solar Radiation data***************');
...
netcdf.close(ncid);
fprintf(fid,'%s\n','Finished reading SUVI-L1b-Fe284 Data');
...
fprintf(fid,'%s\n',statstr2);
%Display RAD as an image-this is for the SUVI_L1b_Fe284 wavelength
