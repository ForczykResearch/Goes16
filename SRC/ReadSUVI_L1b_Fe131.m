function ReadSUVI_L1b_Fe131()
% This function will read in the GOES SUVI_L1B_Fe131
% data which is taken by the Solar Ultraviolet Imager at the Fe093 waveband
% which corresponds to 131 Angstroms
...
fprintf(fid,'\n');
fprintf(fid,'%s\n','**************Start reading SUVI-L1B-Fe131 Solar Radiation data***************');
...
netcdf.close(ncid);
fprintf(fid,'%s\n','Finished reading SUVI-L1b-Fe131 data');
...
fprintf(fid,'%s\n',statstr2);
%Display RAD as an image-this is for the SUVI_L1b_Fe131 wavelength
