function DisplayRadianceData(titlestr,itype,bandnum)
% Display the Radiance Data from the GOES16/17 data
% Derived from DisplayCMIData big change involves using gridded data to
% allow overlay of geographic boundaries
% Written By: Stephen Forczyk
% Created: Dec 21,2020
% Revised: Dec 22,2020 adding correct grids for
% mapping
% Revised: Mar 21,2021 added capability to create PDF reports
% Revised: Mar 26,2021 used colorbar location to automaticaly set text
% position below figure for itype3 and itype 4 plots
...
elseif(itype==3)
    if(bandnum==1)
        GridMatFileName='Meso1Band01RadLatLonsGrid.mat';
    end
    if(bandnum==2)
        GridMatFileName='Meso1Band02RadLatLonsGrid.mat';
    end
    if(bandnum==3)
        GridMatFileName='Meso1Band02RadLatLonsGrid.mat';
    end
    if(bandnum==4)
        GridMatFileName='Meso1Band04RadLatLonsGrid.mat';
    end
    if(bandnum==5)
        GridMatFileName='Meso1Band05RadLatLonsGrid.mat';
    end
    if(bandnum==6)
        GridMatFileName='Meso1Band06RadLatLonsGrid.mat';
    end
    if(bandnum==7)
        GridMatFileName='Meso1Band07RadLatLonsGrid.mat';
    end
    if(bandnum==8)
        GridMatFileName='Meso1Band08RadLatLonsGrid.mat';
    end
    if(bandnum==9)
        GridMatFileName='Meso1Band09RadLatLonsGrid.mat';
    end
    if(bandnum==10)
        GridMatFileName='Meso1Band10RadLatLonsGrid.mat';
    end
    if(bandnum==11)
        GridMatFileName='Meso1Band11RadLatLonsGrid.mat';
    end
    if(bandnum==12)
        GridMatFileName='Meso1Band12RadLatLonsGrid.mat';
    end
    if(bandnum==13)
        GridMatFileName='Meso1Band13RadLatLonsGrid.mat';
    end
    if(bandnum==14)
        GridMatFileName='Meso1Band14RadLatLonsGrid.mat';
    end
    if(bandnum==15)
        GridMatFileName='Meso1Band15RadLatLonsGrid.mat';
    end
    if(bandnum==16)
        GridMatFileName='Meso1Band16RadLatLonsGrid.mat';
    end
elseif(itype==4)
    if(bandnum==1)
        GridMatFileName='Meso2Band01RadLatLonsGrid.mat';
    end
    if(bandnum==2)
        GridMatFileName='Meso2Band02RadLatLonsGrid.mat';
    end
    if(bandnum==3)
        GridMatFileName='Meso2Band02RadLatLonsGrid.mat';
    end
    if(bandnum==4)
        GridMatFileName='Meso2Band04RadLatLonsGrid.mat';
    end
    if(bandnum==5)
        GridMatFileName='Meso2Band05RadLatLonsGrid.mat';
    end
    if(bandnum==6)
        GridMatFileName='Meso2Band06RadLatLonsGrid.mat';
    end
    if(bandnum==7)
        GridMatFileName='Meso2Band07RadLatLonsGrid.mat';
    end
    if(bandnum==8)
        GridMatFileName='Meso2Band08RadLatLonsGrid.mat';
    end
    if(bandnum==9)
        GridMatFileName='Meso2Band09RadLatLonsGrid.mat';
    end
    if(bandnum==10)
        GridMatFileName='Meso2Band10RadLatLonsGrid.mat';
    end
    if(bandnum==11)
        GridMatFileName='Meso2Band11RadLatLonsGrid.mat';
    end
    if(bandnum==12)
        GridMatFileName='Meso2Band12RadLatLonsGrid.mat';
    end
    if(bandnum==13)
        GridMatFileName='Meso2Band13RadLatLonsGrid.mat';
    end
    if(bandnum==14)
        GridMatFileName='Meso2Band14RadLatLonsGrid.mat';
    end
    if(bandnum==15)
        GridMatFileName='Meso2Band15RadLatLonsGrid.mat';
    end
    if(bandnum==16)
        GridMatFileName='Meso2Band16RadLatLonsGrid.mat';
    end
end
