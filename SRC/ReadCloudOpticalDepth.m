function ReadCloudOpticalDepth()
% Modified: This function will read in the GOES measured Cloud Optical
% Depth
...
% Created: Jan 25,2021
% Revised: Jan 27,2021 finished adding logic to read all variables in
% datafile
% Revised: Jan 29,2021 provided minor fixes to update data wreitten to log
% file
...
fprintf(fid,'\n');
fprintf(fid,'%s\n','-----Start reading Cloud Optical Depth data----');
...
CODS=struct('values',[],'long_name',[],'standard_name',[],'FillValue',[],'Unsigned',[],...
    'valid_range',[],'scale_factor',[],'units',[],'resolution',[],'coordinates',[],'grid_mapping',[],...
    'cell_methods',[],'ancillary_variables',[],'add_offset',[]);
CODDayStatS=struct('values1',[],'long_name1',[],'standard_name1',[],'FillValue1',[],...
...
CODNightStatS=CODDayStatS;
OutlierCODS=struct('values1',[],'long_name1',[],'FillValue1',[],'units1',[],...
    'coordinates1',[],'grid_mapping1',[],'cell_methods1',[],...
    'values2',[],'long_name2',[],'FillValue2',[],'units2',[],...
    'coordinates2',[],'grid_mapping2',[],'cell_methods2',[]);
CODWavelengthS=struct('value',[],'long_name',[],'standard_name',[],'units',[]);
...
for i = 0:numvars-1
    ...
    for j = 0:numatts - 1
        ...
        a160=strcmp(varname,'minimum_COD_day');
        a170=strcmp(varname,'maximum_COD_day');
        a180=strcmp(varname,'mean_COD_day');
        a190=strcmp(varname,'std_dev_COD_day');
        a200=strcmp(varname,'minimum_COD_night');
        a210=strcmp(varname,'algorithm_dynamic_input_data_container');
        a220=strcmp(varname,'maximum_COD_night');
        a230=strcmp(varname,'mean_COD_night');
        a240=strcmp(varname,'std_dev_COD_night');
        ...
        a380=strcmp(varname,'outlier_COD_day');
        a390=strcmp(varname,'outlier_COD_night');
        a400=strcmp(varname,'cod_product_wavelength');
        ...
        if (a10==1)
            ...
            if(a1==1)
                CODS.long_name=attname2;
            end
            a1=strcmp(attname1,'standard_name');
            if(a1==1)
                CODS.standard_name=attname2;
            end
       ...
       elseif (a80==1)
        ...
        elseif (a160==1)
            ...
            a1=strcmp(attname1,'long_name');
            if(a1==1)
                CODDayStatS.long_name1=attname2;
            end
            a1=strcmp(attname1,'standard_name');
            if(a1==1)
                CODDayStatS.standard_name1=attname2;
            end
            a1=strcmp(attname1,'_FillValue');
            if(a1==1)
                CODDayStatS.FillValue1=attname2;
            end
            a1=strcmp(attname1,'valid_range');
            if(a1==1)
                CODDayStatS.valid_range1=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                CODDayStatS.units1=attname2;
            end
            a1=strcmp(attname1,'coordinates');
            if(a1==1)
                CODDayStatS.coordinates1=attname2;
            end
            a1=strcmp(attname1,'grid_mapping');
            if(a1==1)
                CODDayStatS.grid_mapping1=attname2;
            end
            a1=strcmp(attname1,'cell_methods');
            if(a1==1)
                CODDayStatS.cell_methods1=attname2;
            end
        elseif (a170==1)
            attname1 = netcdf.inqAttName(ncid,i,j);
            attname2 = netcdf.getAtt(ncid,i,attname1);
            ...
            a1=strcmp(attname1,'long_name');
            if(a1==1)
                CODDayStatS.long_name2=attname2;
            end
            a1=strcmp(attname1,'standard_name');
            if(a1==1)
                CODDayStatS.standard_name2=attname2;
            end
            a1=strcmp(attname1,'_FillValue');
            if(a1==1)
                CODDayStatS.FillValue2=attname2;
            end
            a1=strcmp(attname1,'valid_range');
            if(a1==1)
                CODDayStatS.valid_range2=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                CODDayStatS.units2=attname2;
            end
            a1=strcmp(attname1,'coordinates');
            if(a1==1)
                CODDayStatS.coordinates2=attname2;
            end
            a1=strcmp(attname1,'grid_mapping');
            if(a1==1)
                CODDayStatS.grid_mapping2=attname2;
            end
            a1=strcmp(attname1,'cell_methods');
            if(a1==1)
                CODDayStatS.cell_methods2=attname2;
            end
        elseif (a180==1)
            attname1 = netcdf.inqAttName(ncid,i,j);
            attname2 = netcdf.getAtt(ncid,i,attname1);
            ...
            a1=strcmp(attname1,'long_name');
            if(a1==1)
                CODDayStatS.long_name3=attname2;
            end
            a1=strcmp(attname1,'standard_name');
            if(a1==1)
                CODDayStatS.standard_name3=attname2;
            end
            a1=strcmp(attname1,'_FillValue');
            if(a1==1)
                CODDayStatS.FillValue3=attname2;
            end
            a1=strcmp(attname1,'valid_range');
            if(a1==1)
                CODDayStatS.valid_range3=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                CODDayStatS.units3=attname2;
            end
            a1=strcmp(attname1,'coordinates');
            if(a1==1)
                CODDayStatS.coordinates3=attname2;
            end
            a1=strcmp(attname1,'grid_mapping');
            if(a1==1)
                CODDayStatS.grid_mapping3=attname2;
            end
            a1=strcmp(attname1,'cell_methods');
            if(a1==1)
                CODDayStatS.cell_methods3=attname2;
            end
        elseif (a190==1)
            attname1 = netcdf.inqAttName(ncid,i,j);
            attname2 = netcdf.getAtt(ncid,i,attname1);
            ...
            a1=strcmp(attname1,'long_name');
            if(a1==1)
                CODDayStatS.long_name4=attname2;
            end
            a1=strcmp(attname1,'standard_name');
            if(a1==1)
                CODDayStatS.standard_name4=attname2;
            end
            a1=strcmp(attname1,'_FillValue');
            if(a1==1)
                CODDayStatS.FillValue4=attname2;
            end
            a1=strcmp(attname1,'valid_range');
            if(a1==1)
                CODDayStatS.valid_range4=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                CODDayStatS.units4=attname2;
            end
            a1=strcmp(attname1,'coordinates');
            if(a1==1)
                CODDayStatS.coordinates4=attname2;
            end
            a1=strcmp(attname1,'grid_mapping');
            if(a1==1)
                CODDayStatS.grid_mapping4=attname2;
            end
            a1=strcmp(attname1,'cell_methods');
            if(a1==1)
                CODDayStatS.cell_methods4=attname2;
            end
        elseif (a200==1)
            attname1 = netcdf.inqAttName(ncid,i,j);
            attname2 = netcdf.getAtt(ncid,i,attname1);
            ...
            a1=strcmp(attname1,'long_name');
            if(a1==1)
                CODNightStatS.long_name1=attname2;
            end
            a1=strcmp(attname1,'standard_name');
            if(a1==1)
                CODNightStatS.standard_name1=attname2;
            end
            a1=strcmp(attname1,'_FillValue');
            if(a1==1)
                CODNightStatS.FillValue1=attname2;
            end
            a1=strcmp(attname1,'valid_range');
            if(a1==1)
                CODNightStatS.valid_range1=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                CODNightStatS.units1=attname2;
            end
            a1=strcmp(attname1,'coordinates');
            if(a1==1)
                CODNightStatS.coordinates1=attname2;
            end
            a1=strcmp(attname1,'grid_mapping');
            if(a1==1)
                CODNightStatS.grid_mapping1=attname2;
            end
            a1=strcmp(attname1,'cell_methods');
            if(a1==1)
                CODNightStatS.cell_methods1=attname2;
            end
        elseif (a210==1)
            attname1 = netcdf.inqAttName(ncid,i,j);
            attname2 = netcdf.getAtt(ncid,i,attname1);
        ...
        elseif (a220==1)
            ...
            a1=strcmp(attname1,'long_name');
            if(a1==1)
                CODNightStatS.long_name2=attname2;
            end
            a1=strcmp(attname1,'standard_name');
            if(a1==1)
                CODNightStatS.standard_name2=attname2;
            end
            a1=strcmp(attname1,'_FillValue');
            if(a1==1)
                CODNightStatS.FillValue2=attname2;
            end
            a1=strcmp(attname1,'valid_range');
            if(a1==1)
                CODNightStatS.valid_range2=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                CODNightStatS.units2=attname2;
            end
            a1=strcmp(attname1,'coordinates');
            if(a1==1)
                CODNightStatS.coordinates2=attname2;
            end
            a1=strcmp(attname1,'grid_mapping');
            if(a1==1)
                CODNightStatS.grid_mapping2=attname2;
            end
            a1=strcmp(attname1,'cell_methods');
            if(a1==1)
                CODNightStatS.cell_methods2=attname2;
            end
        elseif (a230==1)
            attname1 = netcdf.inqAttName(ncid,i,j);
            attname2 = netcdf.getAtt(ncid,i,attname1);
            ...
            a1=strcmp(attname1,'long_name');
            if(a1==1)
                CODNightStatS.long_name3=attname2;
            end
            a1=strcmp(attname1,'standard_name');
            if(a1==1)
                CODNightStatS.standard_name3=attname2;
            end
            a1=strcmp(attname1,'_FillValue');
            if(a1==1)
                CODNightStatS.FillValue3=attname2;
            end
            a1=strcmp(attname1,'valid_range');
            if(a1==1)
                CODNightStatS.valid_range3=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                CODNightStatS.units3=attname2;
            end
            a1=strcmp(attname1,'coordinates');
            if(a1==1)
                CODNightStatS.coordinates3=attname2;
            end
            a1=strcmp(attname1,'grid_mapping');
            if(a1==1)
                CODNightStatS.grid_mapping3=attname2;
            end
            a1=strcmp(attname1,'cell_methods');
            if(a1==1)
                CODNightStatS.cell_methods3=attname2;
            end
        elseif (a240==1)
            attname1 = netcdf.inqAttName(ncid,i,j);
            attname2 = netcdf.getAtt(ncid,i,attname1);
            ...
            a1=strcmp(attname1,'long_name');
            if(a1==1)
                CODNightStatS.long_name4=attname2;
            end
            a1=strcmp(attname1,'standard_name');
            if(a1==1)
                CODNightStatS.standard_name4=attname2;
            end
            a1=strcmp(attname1,'_FillValue');
            if(a1==1)
                CODNightStatS.FillValue4=attname2;
            end
            a1=strcmp(attname1,'valid_range');
            if(a1==1)
                CODNightStatS.valid_range4=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                CODNightStatS.units4=attname2;
            end
            a1=strcmp(attname1,'coordinates');
            if(a1==1)
                CODNightStatS.coordinates4=attname2;
            end
            a1=strcmp(attname1,'grid_mapping');
            if(a1==1)
                CODNightStatS.grid_mapping4=attname2;
            end
            a1=strcmp(attname1,'cell_methods');
            if(a1==1)
                CODNightStatS.cell_methods4=attname2;
            end
       elseif (a250==1)
            attname1 = netcdf.inqAttName(ncid,i,j);
            attname2 = netcdf.getAtt(ncid,i,attname1);
        ...
        elseif (a280==1)
         ...
         elseif (a380==1)
            ...
            a1=strcmp(attname1,'long_name');
            if(a1==1)
                OutlierCODS.long_name1=attname2;
            end
            a1=strcmp(attname1,'_FillValue');
            if(a1==1)
                OutlierCODS.FillValue1=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                OutlierCODS.units1=attname2;
            end
            a1=strcmp(attname1,'coordinates');
            if(a1==1)
                OutlierCODS.coordinates1=attname2;
            end
            a1=strcmp(attname1,'grid_mapping');
            if(a1==1)
                OutlierCODS.grid_mapping1=attname2;
            end
            a1=strcmp(attname1,'cell_methods');
            if(a1==1)
                OutlierCODS.cell_methods1=attname2;
            end
        elseif (a390==1)
            attname1 = netcdf.inqAttName(ncid,i,j);
            attname2 = netcdf.getAtt(ncid,i,attname1);
            ...
            a1=strcmp(attname1,'long_name');
            if(a1==1)
                OutlierCODS.long_name2=attname2;
            end
            a1=strcmp(attname1,'_FillValue');
            if(a1==1)
                OutlierCODS.FillValue2=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                OutlierCODS.units2=attname2;
            end
            a1=strcmp(attname1,'coordinates');
            if(a1==1)
                OutlierCODS.coordinates2=attname2;
            end
            a1=strcmp(attname1,'grid_mapping');
            if(a1==1)
                OutlierCODS.grid_mapping2=attname2;
            end
            a1=strcmp(attname1,'cell_methods');
            if(a1==1)
                OutlierCODS.cell_methods2=attname2;
            end
       elseif (a400==1)
            attname1 = netcdf.inqAttName(ncid,i,j);
            attname2 = netcdf.getAtt(ncid,i,attname1);
            ...
            a1=strcmp(attname1,'long_name');
            if(a1==1)
                CODWavelengthS.long_name=attname2;
            end
            a1=strcmp(attname1,'standard_name');
            if(a1==1)
                CODWavelengthS.standard_name=attname2;
            end
            a1=strcmp(attname1,'units');
            if(a1==1)
                CODWavelengthS.units=attname2;
            end
        elseif (a460==1)
            attname1 = netcdf.inqAttName(ncid,i,j);
            attname2 = netcdf.getAtt(ncid,i,attname1);
    ...
    if flag
        if(a10==1)
            ...
            FillValue=CODS.FillValue;
               [COD,numnanvals] = ReplaceFillValues(COD,FillValue);
               [nrows,ncols]=size(COD);
               level=(2^15)-1;
               for ik=1:nrows
                   for jk=1:ncols
                      value=COD(ik,jk);
               ...
               COD2=COD'*scale+offset;
               CODS.values=double(COD2); 
               clear COD2
        end
        if(a40==1)
        ...
        if(a160==1)
            CODDayStatS.values1=minimum_COD_day;
        end
        if(a170==1)
            CODDayStatS.values2=maximum_COD_day;
        end
        if(a180==1)
            CODDayStatS.values3=mean_COD_day;
        end
        if(a190==1)
            CODDayStatS.values4=std_dev_COD_day;
        end
        if(a200==1)
            CODNightStatS.values1=minimum_COD_night;
        end
        if(a210==1)
            AlgoS.values='null';
        end
        if(a220==1)
            CODNightStatS.values2=maximum_COD_night;
        end
        if(a230==1)
            CODNightStatS.values3=mean_COD_night; 
        end
        if(a240==1)
            CODNightStatS.values4=std_dev_COD_night;
        end
        if(a250==1)
        ...
        if(a380==1)
            OutlierCODS.values1=outlier_COD_day;
        end
        if(a390==1)
             OutlierCODS.values2=outlier_COD_night;
        end
        if(a400==1)
            CODWavelengthS=cod_product_wavelength;
        end
        if(a460==1)
...
% Close the file
netcdf.close(ncid);
fprintf(fid,'%s\n','Finished Read Cloud Optical Depth data');
...
if(isavefiles==1)
    ...
    actionstr='save';
    varstr1='CODS MetaDataS  DQFS tS yS xS tBS goesImagerS';
    ...
    varstr6=' CODDayStatS CODNightStatS OutlierCODS CODWavelengthS';
...
fprintf(fid,'%s\n',geostr2);
[numrows,numcols]=size(CODS.values);
GeoRef = georefcells();
...
datastr1=strcat('Cloud Optical Depth dimensions nrows=',num2str(numrows),...
...
titlestr=strcat('CloudOpticalDepth-',filename);
[COD1DSF,sgoodfrac]=DisplayCONUSOpticalDepth(titlestr);
titlestr=strcat('CloudOpticalDepthHist-',filename);
PlotCloudOpticalDepthHistogram(COD1DSF,sgoodfrac,titlestr)
titlestr=strcat('CloudOpticalCumilDist-',filename);
PlotCloudDepthCumilDist(COD1DSF,sgoodfrac,titlestr)
fprintf(fid,'%s\n','Finished Processing Cloud Optical Depth data');
disp('-----Finished Processing Cloud Optical Data-----');
end