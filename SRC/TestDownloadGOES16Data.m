...
if(icase==1)
    downloadpath='F:\GOES16\Test\July12_2020\Derived_Motion_Winds\';
    urlstub = 'https://noaa-goes16/ABI-L2-DMWF/2020/194/00/';
    filex = 'https://people.sc.fsu.edu/~jburkardt/m_src/r8lib/';
    fileext='.nc';
elseif(icase==2)
    downloadpath='F:\GOES16\Test\July12_2020\Derived_Motion_Winds\'; 
    urlstub='https://noaa-goes16.s3.amazonaws.com/ABI-L1b-RadC/2020/001/00/OR_ABI-L1b-RadC-M6C01_G16_s20200010001184_e20200010003557_c20200010004028.nc/';
