function ReadManyL2FireFiles(nowFile)
% Modified: This function will read in the ABI-L2-Fire data for multiple
% files. No fire plots will be created
...
global nationalshapepath countyshapepath;
...
fprintf(fid,'%s\n','////// Completed Execution Of Routine ReadManyL2FireFiles //////');
end
