% Test download from HTTP-Rev3 is designed to use a select case
...
if(icase==1)
    downloadpath='F:\GOES16\Test3\';
    urlstub = 'https://osdc.rcc.uchicago.edu/noaa-goes16/ABI-L2-MCMIPC/2020/240/00/';
    filex = 'https://osdc.rcc.uchicago.edu/noaa-goes16/ABI-L2-MCMIPC/2020/240/00/';
    fileext='.nc';
elseif(icase==2)
